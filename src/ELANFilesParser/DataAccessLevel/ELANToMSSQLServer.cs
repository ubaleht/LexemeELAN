...
namespace ELANToDatabase
{
    public class ELANToMSSQLServer
    {
                ...
                using (var conn = new SqlConnection(connectionString))
                {
                    ...
                    { 
                        ...
                        for (int fragmentIndex = startRange; fragmentIndex < endRange; fragmentIndex++)
                        {
                            ...
                            cmd.Parameters.AddWithValue("@FileNameFieldWorkFile" + fragmentIndex.ToString(), "AAK-47-001");
                            cmd.ExecuteNonQuery();
                            ...
                            for (int speakerIndex = 0; speakerIndex < annotationsFragments[fragmentIndex].SpeakerSpeeches.Count; speakerIndex++)
                            {
                                ...
                                cmd.Parameters.AddWithValue("@SpeakerPersonalCode" + speakerVarName, "AAK-47");
                                cmd.ExecuteNonQuery();
        ...
        public void SaveELANStyFileToDatabase(List<AnnotationsFragmentSty> annotationsFragments)
        {
            int startRange = 0;
            int endRange = 0;
            bool flag = true;
                ...
                using (var conn = new SqlConnection(connectionString2))
                {
                    using (SqlCommand cmd = conn.CreateCommand())
                    {
                        ...
                        for (int fragmentIndex = startRange; fragmentIndex < endRange; fragmentIndex++)
                        {
                            ...
                            cmd.Parameters.AddWithValue("@Start" + fragmentIndex.ToString(), annotationsFragments[fragmentIndex].StartTime);
                            cmd.Parameters.AddWithValue("@Finish" + fragmentIndex.ToString(), annotationsFragments[fragmentIndex].EndTime);
                            cmd.Parameters.AddWithValue("@FileNameFieldWorkFile" + fragmentIndex.ToString(), "NGA-45_2021-07-22_03");
                            cmd.ExecuteNonQuery();
                            ...
                            {
                                string interviewerVarName = fragmentIndex.ToString() + interviewerIndex.ToString();
                                cmd.CommandText = "INSERT INTO InterviewerSpeech (IdGeneralFragment, Start, Finish, InterviewerSpeech, InterviewerSpeechEnTranslation, InterviewerSpeechTrTranslation, InterviewerPersonalCode) VALUES (@IdGeneralFragment"
                                    + interviewerVarName + ", @InterviewerStart" + interviewerVarName + ", @InterviewerFinish" + interviewerVarName +
                                    ", @InterviewerSpeech" + interviewerVarName + ", @InterviewerSpeechEnTranslation" + interviewerVarName + ", @InterviewerSpeechTrTranslation" + interviewerVarName + ", @InterviewerPersonalCode" + interviewerVarName + ")";
                                cmd.Parameters.AddWithValue("@IdGeneralFragment" + interviewerVarName, generalFragmentId);
                                cmd.Parameters.AddWithValue("@InterviewerStart" + interviewerVarName, annotationsFragments[fragmentIndex].InterviewerSpeeches[interviewerIndex].StartTime);
                                cmd.Parameters.AddWithValue("@InterviewerFinish" + interviewerVarName, annotationsFragments[fragmentIndex].InterviewerSpeeches[interviewerIndex].EndTime);
                                cmd.Parameters.AddWithValue("@InterviewerSpeech" + interviewerVarName, (annotationsFragments[fragmentIndex].InterviewerSpeeches[interviewerIndex].InterviewerSpeechText != null) ? annotationsFragments[fragmentIndex].InterviewerSpeeches[interviewerIndex].InterviewerSpeechText : String.Empty);
                                cmd.Parameters.AddWithValue("@InterviewerSpeechEnTranslation" + interviewerVarName, (annotationsFragments[fragmentIndex].InterviewerSpeeches[interviewerIndex].InterviewerSpeechEnTranslation != null) ? annotationsFragments[fragmentIndex].InterviewerSpeeches[interviewerIndex].InterviewerSpeechEnTranslation : String.Empty);
                                cmd.Parameters.AddWithValue("@InterviewerSpeechTrTranslation" + interviewerVarName, (annotationsFragments[fragmentIndex].InterviewerSpeeches[interviewerIndex].InterviewerSpeechTrTranslation != null) ? annotationsFragments[fragmentIndex].InterviewerSpeeches[interviewerIndex].InterviewerSpeechTrTranslation : String.Empty);
                                cmd.Parameters.AddWithValue("@InterviewerPersonalCode" + interviewerVarName, "UIP-80");
                                cmd.ExecuteNonQuery();
                            }
                            ...
                            {
                                string speakerVarName = fragmentIndex.ToString() + speakerIndex.ToString();
                                cmd.CommandText = "INSERT INTO SpeakerSpeech(IdGeneralFragment, Start, Finish, Speech, SpeechEnTranslation, SpeechRuTranslation, SpeechTrTranslation, SpeechLatin, SpeakerPersonalCode) VALUES(@IdGeneralFragmentForSpeech" + speakerVarName + ", @SpeechStart" + speakerVarName
                                    + ", @SpeechFinish" + speakerVarName + ", @SpeakerSpeech" + speakerVarName + ", @SpeakerSpeechEnTranslation" + speakerVarName + ", @SpeakerSpeechRuTranslation" + speakerVarName + ", @SpeakerSpeechTrTranslation" + speakerVarName
                                    + ", @SpeakerSpeechLatin" + speakerVarName + ", @SpeakerPersonalCode" + speakerVarName + ")";
                                cmd.Parameters.AddWithValue("@IdGeneralFragmentForSpeech" + speakerVarName, generalFragmentId);
                                cmd.Parameters.AddWithValue("@SpeechStart" + speakerVarName, annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].StartTime);
                                cmd.Parameters.AddWithValue("@SpeechFinish" + speakerVarName, annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].EndTime);
                                cmd.Parameters.AddWithValue("@SpeakerSpeech" + speakerVarName, (annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerSpeechText != null) ? annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerSpeechText : String.Empty);
                                cmd.Parameters.AddWithValue("@SpeakerSpeechEnTranslation" + speakerVarName, (annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerSpeechEnTranslation != null) ? annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerSpeechEnTranslation : String.Empty);
                                cmd.Parameters.AddWithValue("@SpeakerSpeechRuTranslation" + speakerVarName, (annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerSpeechRuTranslation != null) ? annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerSpeechRuTranslation : String.Empty);
                                cmd.Parameters.AddWithValue("@SpeakerSpeechTrTranslation" + speakerVarName, (annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerSpeechTrTranslation != null) ? annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerSpeechTrTranslation : String.Empty);
                                cmd.Parameters.AddWithValue("@SpeakerSpeechLatin" + speakerVarName, (annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerSpeechLatin != null) ? annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerSpeechLatin : String.Empty);
                                cmd.Parameters.AddWithValue("@SpeakerPersonalCode" + speakerVarName, "NGA-45");
                                cmd.ExecuteNonQuery();

                                cmd.CommandText = "SELECT Id FROM SpeakerSpeech WHERE Id = @@Identity";
                                var speakerSpeechId = cmd.ExecuteScalar();

                                for (int wordIndex = 0; wordIndex < annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerWordsSty.Count; wordIndex++)
                                {
                                    string wordVarName = fragmentIndex.ToString() + speakerIndex.ToString() + wordIndex.ToString();
                                    cmd.CommandText = "INSERT INTO Word(IdSpeakerSpeech, Start, Finish, Word, WordEnTranslation, WordRuTranslation, WordTrTranslation, WordLatin, PartOfSpeech, WordComments) VALUES(@IdSpeakerSpeech" + wordVarName + ", @WordStart" + wordVarName
                                        + ", @WordFinish" + wordVarName + ", @WordText" + wordVarName + ", @WordEnTranslation" + wordVarName + ", @WordRuTranslation" + wordVarName + ", @WordTrTranslation" + wordVarName + ", @WordLatin" + wordVarName
                                        + ", @PartOfSpeech" + wordVarName + ", @WordComments" + wordVarName + ")";
                                    cmd.Parameters.AddWithValue("@IdSpeakerSpeech" + wordVarName, speakerSpeechId);
                                    cmd.Parameters.AddWithValue("@WordStart" + wordVarName, annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerWordsSty[wordIndex].StartTime);
                                    cmd.Parameters.AddWithValue("@WordFinish" + wordVarName, annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerWordsSty[wordIndex].EndTime);
                                    cmd.Parameters.AddWithValue("@WordText" + wordVarName, (annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerWordsSty[wordIndex].SpeakerWordText != null) ? annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerWordsSty[wordIndex].SpeakerWordText : String.Empty);
                                    cmd.Parameters.AddWithValue("@WordEnTranslation" + wordVarName, (annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerWordsSty[wordIndex].SpeakerWordsEnTranslation != null) ? annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerWordsSty[wordIndex].SpeakerWordsEnTranslation : String.Empty);
                                    cmd.Parameters.AddWithValue("@WordRuTranslation" + wordVarName, (annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerWordsSty[wordIndex].SpeakerWordsRuTranslation != null) ? annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerWordsSty[wordIndex].SpeakerWordsRuTranslation : String.Empty);
                                    cmd.Parameters.AddWithValue("@WordTrTranslation" + wordVarName, (annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerWordsSty[wordIndex].SpeakerWordTrTranslation != null) ? annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerWordsSty[wordIndex].SpeakerWordTrTranslation : String.Empty);
                                    cmd.Parameters.AddWithValue("@WordLatin" + wordVarName, (annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerWordsSty[wordIndex].SpeakerWordLatin != null) ? annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerWordsSty[wordIndex].SpeakerWordLatin : String.Empty);
                                    cmd.Parameters.AddWithValue("@PartOfSpeech" + wordVarName, (annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerWordsSty[wordIndex].SpeakerPartOfSpeech != null) ? annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerWordsSty[wordIndex].SpeakerPartOfSpeech : String.Empty);
                                    cmd.Parameters.AddWithValue("@WordComments" + wordVarName, (annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerWordsSty[wordIndex].SpeakerWordsComments != null) ? annotationsFragments[fragmentIndex].SpeakerSpeeches[speakerIndex].SpeakerWordsSty[wordIndex].SpeakerWordsComments : String.Empty);
                                    cmd.ExecuteNonQuery();
                                }
                            }
                        }
